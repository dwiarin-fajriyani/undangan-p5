...
<body data-email="user@example.com" data-password="12345678" data-url="https://api.ulems.my.id/" style="overflow-y: hidden;">
    ...
    <!-- Navbar Bottom -->
    <nav class="navbar navbar-dark navbar-expand fixed-bottom rounded-top-4 p-0" style="background-color: #032531;" id="navbar-menus">
        <ul class="navbar-nav nav-justified w-100 align-items-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#tentang">
                    ...
                    <span class="d-block" style="font-size: 0.7rem;">Tentang</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#rundown">
                    <i class="fa-solid fa-hourglass"></i>
                    <span class="d-block" style="font-size: 0.7rem;">Rundown</span>
                </a>
            </li>
            <!-- <li class="nav-item">
    ...
    <main class="text-light" data-bs-spy="scroll" data-bs-target="#navbar-menus" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <!-- Home -->
        <section class="container" id="home" style="background-color: #C4D7F8;">

            <div class="text-center pt-5">
                <div class="m-3" style="display: flex; justify-content: center;">
                    <img src="assets/images/provjabar.png" height="40" alt="Prov Jawa Barat">
                    <img src="assets/images/disdikjabar.png" height="40" alt="Disdik Jawa Barat"> &nbsp;
                    <img src="assets/images/smkn2.png" height="40" alt="SMKN 2 Sumedang">
    
                </div>
                <h1 class="font-plain my-4" style="font-size: 2rem; font-weight: bold;">SMKN 2 Sumedang</h1>
                <h3 class="font-plain my-4" style="font-size: 1rem;">PROUDLY PRESENT</h1>
                ...
                <br><br><br><br>
                <h1 class="font-esthetic my-2" style="font-size: 2rem;">Panen Karya P5</h1>
                <h1 class="font-esthetic mt-2 mb-5" style="font-size: 3rem;">Kearifan Lokal</h1>
                <!-- <p class="mb-0" style="font-size: 1.5rem;">Rabu, 15 Maret 2023</p> -->

                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Panen%20Karya%20P5%20SMKN%202%20Sumedang&details=Panen%20Karya&dates=20240220T080000/20240220T150000&location=https://goo.gl/maps/6KBDY19SgHPLbnVT8">
        ...
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            ...
            <path fill="#8CB6DE" fill-opacity="1" d="M0,160L48,144C96,128,192,96,288,106.7C384,117,480,171,576,165.3C672,160,768,96,864,96C960,96,1056,160,1152,154.7C1248,149,1344,75,1392,37.3L1440,0L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
        ...
        <section class="dark-section" id="tentang">
            ...
            <div class="text-center">
                ...
                <h1 class="font-esthetic py-3 px-2" style="font-size: 2.5rem">About Panen Karya</h1>
                
                    <div class="container pb-4 pt-2">
                        <p class="py-3 px-3">
                            Panen Karya P5 merupakan salah satu program dalam kurikulum baru yang bertujuan untuk menggelar karya keterampilan siswa. Panen Karya P5 kali ini bertemakan tentang Kearifan Lokal
                            yang akan diisi dengan Simulasi Tradisi Pernikahan Adat Sunda dengan menampilkan berbagai kesenian juga kebudayaan hasil dari para siswa.
                        </p>
                    </div>
                    <img src="assets/images/background-undangan.png" alt="" width="100%" data-aos="fade-down" data-aos-duration="1000">
        ...
        <!-- Wave Separator -->
        <!-- <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#8CB6DE" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,149.3C320,149,400,171,480,165.3C560,160,640,128,720,128C800,128,880,160,960,186.7C1040,213,1120,235,1200,218.7C1280,203,1360,149,1400,122.7L1440,96L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path>
        </svg> -->
        ...
        <!-- Tanggal -->
        <section class="navy-section" id="tanggal">

            <div class="container">
                <div class="text-center">
                    <br><br><br>
                    <h1 class="font-esthetic-white py-3" style="font-size: 2.5rem;">Waktu dan Tempat</h1>
                    <!-- <div class="py-2 px-4 mx-2 mb-4">
                    </div>
                    ...
                    <div class="card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down" data-aos-duration="1500">
                        <h1 class="font-esthetic text-center mb-3" style="font-size: 2rem;">Save The Date</h1>    
                        <div class="mb-2">
                            <p>Sunday</p>
                            <div class="tanggal">
                                    <div><h5 style="font-size: 3rem;">20</h5></div>
                                    <div class="line mx-2"></div>
                                    <div><p style="text-align: left;">Februari <br> 2024</p></div>
                            </div>
                            <p> 12:30 - 15:00  </p>
                            <h5 style="font-size: 1.5rem;">Kampus SMKN 2 Sumedang</h5></div>
                            <p> Jalan Arief Rakhman Hakim No. 59 Sumedang </p>
                        ...
                        <div class="py-2 px-4 mx-2 mb-4">
                            ...
                            <div class="row justify-content-center" data-waktu="2024-02-20 00:00:00" id="tampilan-waktu">
                                <div class="col-3 p-1">
        ...
        <section id="rundown">
            <div class="row mt-5">
                <div class="col-md-12">
                    <div id="content">
                        <h1 class="font-esthetic text-center mb-5" style="font-size: 2.5rem;">Rangkaian Acara</h1>
                        <ul class="timeline">
                            <li class="event" data-date="07.00 - 07.30 WIB">
                                <h3>Registrasi</h3>
                                <p>Semua tamu undangan melakukan registrasi</p>
                            </li>
                            <li class="event" data-date="07.30 - 08.00 WIB">
                                <h3>Pembukaan Acara</h3>
                                <p>Acara panen karya P5 akan dibuka oleh Kepala SMKN 2 Sumedang bersama Kepala Dinas Pendidikan Prov. Jawa Barat</p>
                            </li>
                            <li class="event" data-date="08.00 - 10.30 WIB">
                                <h3>Simulasi Akad Nikah dan Prosesi Adat Sunda </h3>
                                <p>Kegiatan dimulai dari prosesi kedatangan CPP sampai prosesi acara adat sunda (Sungkem, huap lingkung, bantayan, dan sawer)</p>
                            </li>
                            <li class="event" data-date="10.30 - 12.30 WIB">
                                <h3>Simulasi Prosesi Resepsi</h3>
                                <p>Kegiatan dimulai dari kirab pengantin sampai dengan ramah tamah juga sesi foto dan parasmanan.</p>
                            </li>
                            <li class="event" data-date="13.00 - 14.00 WIB">
                                <h3>Penutup dan Doa</h3>
                                <p>Diisi dengan hiburan juga do'a bersama sebagai penutup acara.</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <!-- Ucapan -->
        <!-- <section class="my-5 p-3" id="ucapan">
            <div class="container">
        ...
        <div class="container dark-section">
            <div class="py-4">
                ...
                <div class="text-center">
                    ...
                    <h1 class="font-esthetic mt-0 mb-3" style="font-size: 3rem;">Terima Kasih</h1>

                    <p class="mb-5" style="font-size: 0.9rem;">
                        Terima kasih Bapak/Ibu sudah meluangkan waktu untuk melihat penampilan siswa/siswi SMKN 2 Sumedang. 
                    </p>
    ...
    <footer>
        <div class="container">
            <div class="text-center">
                ...
                <p style="font-size: 0.9rem; font-color:white" class="pt-2 pb-1 px-2" data-aos="fade-up" data-aos-duration="1500">
                    Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila, Bapak / Ibu / Saudara / i.
                    berkenan hadir untuk memberikan do'a restunya kami ucapkan terimakasih.
                </p>

                <h1 class="font-esthetic-white" data-aos="fade-up" data-aos-duration="2000">Panen Karya P5</h1>
                <h1 data-aos="fade-up" data-aos-duration="2000" style="font-size: 1rem; color: white;">@smkn2sumedang.official</h1><br>
                ...
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <small class="text-light">
                            Build with<i class="fa-solid fa-heart mx-1"></i>Div IT SMKN 2 Sumedang
                        </small>
                    </div>
                    <!-- <div class="col-auto">
                        <small>
    ...
    <!-- Welcome Page -->
    <div class="loading-page" id="welcome" style=" background-image:url(assets/images/back.jpg); background-position: center; background-size: cover; opacity:1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 70vh !important;">
            ...
            <div class="text-center">
                ...
                <h1 class="font-esthetic mb-2" style="font-size: 3rem;">Panen Karya <br>  Kearifan Lokal</h1>
                <h1 class="font-plain mb-4" style="font-size: 1.2rem; font-weight: bold;">SMK NEGERI 2 SUMEDANG</h1><br><br><br>

                <!-- <div class="img-crop border border-3 border-light shadow mb-4 mx-auto">
                    <img src="./assets/images/bg.jpeg" alt="bg">
                </div> -->

                <h1 class="font-plain my-4" style="font-size: 1rem;">Kepada Yth.</h1>
                <h1 class="font-plain my-4" style="font-size: 1rem;">

                <?php
                echo isset($_GET['nama'])?$_GET['nama']: 'Nama Tamu';?>
                </h1>
